...
with lib; 
let
  inherit (import ./dag.nix { inherit lib; }) entryBefore entryAfter;
  inherit (import ./strings.nix { inherit lib; }) storeFileName;
  inherit (import ./types-dag.nix { inherit lib; }) dagOf;
...
in
{
  ...
  config = {
    ...
    home.activation.checkLinkTargets = entryBefore ["writeBoundary"] (
      let
    ...
    home.activation.linkGeneration = entryAfter ["writeBoundary"] (
      let
    ...
    home.activation.checkFilesChanged = entryBefore ["linkGeneration"] (
      let
    ...
    home.activation.onFilesChange = entryAfter ["linkGeneration"] (
      concatMapStrings (v: ''
